// writing a function that decomposes a number into its integer part and decimal part
...
int main(void)
{
    ...
    /****** This won't work without pointers -- go read about it you fucking dumbass */
